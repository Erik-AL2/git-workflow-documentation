...
export function GitPullRequest({ className, ...props }: IconProps) {
  return (
    ...
    >
      ...
      <circle cx="18" cy="18" r="3" />
      <path d="M18 9v6" />
      <path d="M18 6V5a2 2 0 0 0-2-2h-5" />
      <polyline points="8 6 11 3 8 0" transform="translate(0 3)" />
    </svg>
  );
}
...
export function CheckSquare({ className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function Square({ className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function FileCode2({ className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function FileJson({ className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function ZoomIn({ className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function ZoomOut({ className, ...props }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
// Alias exports for compatibility with existing code that uses Icon suffix
export {
  Check as CheckIcon,
